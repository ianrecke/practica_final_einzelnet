...
def result():
    if request.method == 'POST':
        ...
        return render_template("result.html", fecha1=fecha,result=round(result[0][0],3)*100,result2 = round(result2[0][0],3)*100,fecha2 = fecha2,diferencia_pais1 = diferencia_pais1,diferencia_pais2 = diferencia_pais2,pais1 = to_predict_list[2],pais2 = to_predict_list[3])
